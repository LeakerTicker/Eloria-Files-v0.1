...
monster.attacks = {
	{ name = "melee", interval = 2000, chance = 100, minDamage = 0, maxDamage = -595 },
	{ name = "combat", interval = 3500, chance = 38, type = COMBAT_PHYSICALDAMAGE, minDamage = -455, maxDamage = -840, range = 4, shootEffect = CONST_ANI_LARGEROCK, target = true },
	{ name = "combat", interval = 4100, chance = 30, type = COMBAT_ENERGYDAMAGE, minDamage = -280, maxDamage = -630, radius = 5, effect = CONST_ME_EXPLOSIONAREA, target = false },
}
