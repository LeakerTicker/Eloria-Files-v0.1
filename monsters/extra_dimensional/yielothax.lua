...
monster.loot = {
	...
	{ name = "broken ring of ending", chance = 5000 },
...
monster.attacks = {
	...
	{ name = "combat", interval = 3000, chance = 10, type = COMBAT_LIFEDRAIN, minDamage = -100, maxDamage = -110, length = 4, spread = 0, effect = CONST_ME_ENERGYAREA, target = false },
	{ name = "combat", interval = 3000, chance = 15, type = COMBAT_EARTHDAMAGE, minDamage = -150, maxDamage = -150, radius = 3, effect = CONST_ME_HITBYPOISON, target = false },
	{ name = "combat", interval = 3000, chance = 15, type = COMBAT_EARTHDAMAGE, minDamage = -70, maxDamage = -120, radius = 3, effect = CONST_ME_HITBYPOISON, target = true },
	{ name = "combat", interval = 3000, chance = 10, type = COMBAT_MANADRAIN, minDamage = -50, maxDamage = -150, length = 4, spread = 0, effect = CONST_ME_MAGIC_RED, target = false },
}
