local mType = Game.createMonsterType("Dreloriax")
local monster = {}

monster.description = "Dreloriax"
...
monster.loot = {
	...
	{ id = 51033, chance = 7000}, -- Upgrade Crystal lvl 3
	...
	{ id = 46290, chance = 3550}, -- chronobag
	{ id = 46302, chance = 3551}, -- mistery bag
...
monster.attacks = {
	...
	{ name = "combat", interval = 3000, chance = 55, type = COMBAT_ICEDAMAGE, minDamage = -1320, maxDamage = -2200, range = 7, radius = 7, shootEffect = CONST_ANI_ICE, effect = 243, target = true },
	{ name = "combat", interval = 2000, chance = 35, type = COMBAT_DEATHDAMAGE, minDamage = -1000, maxDamage = -2200, length = 8, spread = 0, effect = 252, target = false },
	{ name = "combat", interval = 2000, chance = 55, type = COMBAT_FIREDAMAGE, minDamage = -1600, maxDamage = -2800, length = 8, spread = 0, effect = 249, target = false },
	{ name = "combat", interval = 2000, chance = 34, type = COMBAT_FIREDAMAGE, minDamage = -2480, maxDamage = -3120, range = 7, radius = 7, shootEffect = CONST_ANI_FIRE, effect = CONST_ME_FIREAREA, target = true },
	{ name = "combat", interval = 2000, chance = 35, type = COMBAT_LIFEDRAIN, minDamage = -800, maxDamage = -2680, length = 8, spread = 0, effect = CONST_ME_MAGIC_RED, target = false },
}
