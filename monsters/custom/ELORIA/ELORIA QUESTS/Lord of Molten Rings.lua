local mType = Game.createMonsterType("Lord of Molten Rings")
local monster = {}

monster.description = "Lord of Molten Rings"
...
monster.voices = {
	interval = 5000,
	chance = 30,
	{ text = "Gold is eternal! You are not!", yell = true },
	{ text = "Kneel before molten wealth!", yell = true },
	{ text = "Every ring has its price!", yell = true },
	{ text = "Your worth? Less than dust!", yell = true },
}
...
monster.loot = {
	...
	{ id = 43950, chance = 100500, minCount = 1, maxCount = 10 },  -- Abridged Promotion Scroll
...
monster.attacks = {
	...
	{ name = "combat", interval = 2000, chance = 40, type = COMBAT_EARTHDAMAGE, minDamage = -4188, maxDamage = -6388, length = 8, spread = 5, effect = CONST_ME_GREEN_RINGS, target = false },
