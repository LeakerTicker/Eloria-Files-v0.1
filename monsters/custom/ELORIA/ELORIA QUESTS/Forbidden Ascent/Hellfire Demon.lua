local mType = Game.createMonsterType("Hellfire Demon")
local monster = {}

monster.description = "a Hellfire Demon"
...
monster.voices = {
	interval = 5000,
	chance = 20,
	{ text = "Your soul will burn as my flames consume all!", yell = false },
	{ text = "I drag mortals into the abyss… and you will follow!", yell = false },
	{ text = "Your fate is sealed… darkness answers to me!", yell = false },
}
