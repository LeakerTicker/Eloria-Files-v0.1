local mType = Game.createMonsterType("Eternal Demon")
local monster = {}

monster.description = "a eternal demon"
...
monster.summon = {
	maxSummons = 4,
	summons = {
		{ name = "Burning Guard", chance = 60, interval = 3000, count = 2 },
	},
}
...
monster.voices = {
	...
	{ text = "I AM KEEPER OF THE SANGUINE... AND I AM HERE TO CHALLENGE YOU ALL.", yell = true },
...
monster.attacks = {
	...
	{ name = "combat", interval = 3000, chance = 20, type = COMBAT_PHYSICALDAMAGE, minDamage = -2300, maxDamage = -3720, range = 14, radius = 5, effect = CONST_ME_POFF, target = false },
	{ name = "combat", interval = 4000, chance = 15, type = COMBAT_PHYSICALDAMAGE, minDamage = -2150, maxDamage = -3975, range = 7, radius = 13, effect = CONST_ME_BLOCKHIT, target = false },
	{ name = "combat", interval = 4000, chance = 18, type = COMBAT_PHYSICALDAMAGE, minDamage = -2300, maxDamage = -3900, radius = 14, effect = CONST_ME_LOSEENERGY, target = false },
	{ name = "combat", interval = 3000, chance = 15, type = COMBAT_PHYSICALDAMAGE, minDamage = -2300, maxDamage = -3125, range = 7, radius = 4, effect = CONST_ME_ENERGYAREA, target = false },
