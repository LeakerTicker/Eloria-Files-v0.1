local mType = Game.createMonsterType("Valiant Ghost")
local monster = {}

monster.description = "a Valiant Ghost"
...
monster.attacks = {
	{ name = "melee", interval = 2000, chance = 100, minDamage = 0, maxDamage = -966 },  -- 1380*0.7=966
	{ name = "combat", interval = 2000, chance = 15, type = COMBAT_FIREDAMAGE, minDamage = -1152, maxDamage = -1911, length = 8, spread = 3, effect = CONST_ME_SKULLVERTICAL, target = false },  -- 1645*0.7=1152, 2730*0.7=1911
	{ name = "combat", interval = 2000, chance = 15, type = COMBAT_MANADRAIN, minDamage = -245, maxDamage = -735, length = 8, spread = 3, effect = CONST_ME_MORTAREA, target = false },  -- 350*0.7=245, 1050*0.7=735
	{ name = "lava golem soulfire", interval = 2000, chance = 15, target = false },
	{ name = "combat", interval = 2000, chance = 25, type = COMBAT_FIREDAMAGE, minDamage = -1137, maxDamage = -1936, radius = 4, effect = CONST_ME_YELLOWENERGY, target = true },  -- 1624*0.7=1137, 2765*0.7=1936
	...
	{ name = "combat", interval = 2000, chance = 30, type = COMBAT_FIREDAMAGE, minDamage = -1117, maxDamage = -1936, radius = 3, effect = CONST_ME_HITBYFIRE, target = false },  -- 1596*0.7=1117, 2765*0.7=1936
}
