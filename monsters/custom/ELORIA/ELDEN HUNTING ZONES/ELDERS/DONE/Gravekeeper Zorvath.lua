local mType = Game.createMonsterType("Gravekeeper Zorvath")
local monster = {}

monster.description = "a Gravekeeper Zorvath"
...
monster.loot = {
	...
	{ name = "Gravekeeper flesh", chance = 1300, minCount = 1, maxCount = 2 },
...
monster.attacks = {
	...
	{ name = "combat", interval = 2000, chance = 30, type = COMBAT_ENERGYDAMAGE, minDamage = -2120, maxDamage = -2814, radius = 4, effect = CONST_ME_GROUNDSHAKER, target = false }, -- 3028*0.7=2120, 4020*0.7=2814
	{ name = "combat", interval = 2000, chance = 20, type = COMBAT_FIREDAMAGE, minDamage = -2120, maxDamage = -3542, radius = 3, effect = CONST_ME_FIREATTACK, target = false }, -- 3028*0.7=2120, 5060*0.7=3542
	{ name = "combat", interval = 2000, chance = 35, type = COMBAT_EARTHDAMAGE, minDamage = -2469, maxDamage = -2884, range = 7, shootEffect = CONST_ANI_EARTH, effect = CONST_ME_DRAWBLOOD, target = true }, -- 3528*0.7=2469, 4120*0.7=2884
}
