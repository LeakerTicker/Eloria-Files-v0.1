local mType = Game.createMonsterType("Halloween Rat")
local monster = {}

monster.description = "an Halloween Rat"
...
monster.loot = {
	{ id = 49570, chance = 15000 },  -- halloween token
...
monster.defenses = {
	...
	armor = 28,
	mitigation = 1.46,
	{ name = "invisible", interval = 2000, chance = 55, effect = CONST_ME_MAGIC_BLUE },
}
