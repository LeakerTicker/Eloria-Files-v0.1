...
monster.attacks = {
	...
	{ name = "combat", interval = 3000, chance = 40, type = COMBAT_ENERGYDAMAGE, minDamage = -420, maxDamage = -700, range = 3, effect = CONST_ME_BLUE_ENERGY_SPARK, target = true },
	{ name = "mercurial menace ring", interval = 4500, chance = 37, minDamage = -210, maxDamage = -350 },
}
