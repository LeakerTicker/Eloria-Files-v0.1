...
monster.attacks = {
	...
	{ name = "energy chain", interval = 5000, chance = 37, minDamage = -550, maxDamage = -800, range = 3, target = true },
	...
	{ name = "emerald tortoise large ring", interval = 3500, chance = 35, minDamage = -550, maxDamage = -800 },
	{ name = "emerald tortoise small ring", interval = 4500, chance = 20, minDamage = -350, maxDamage = -500 },
	{ name = "emerald tortoise small explosion", interval = 3800, chance = 30, minDamage = -300, maxDamage = -400 },
	{ name = "combat", interval = 4100, chance = 30, type = COMBAT_ENERGYDAMAGE, minDamage = -450, maxDamage = -550, radius = 3, effect = CONST_ME_BLUE_ENERGY_SPARK, target = false },
}
