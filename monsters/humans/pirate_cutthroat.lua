...
monster.loot = {
	{ name = "gold coin", chance = 3000, maxCount = 50 },
	{ name = "scale armor", chance = 1000 },
	{ name = "steel shield", chance = 1800 },
	{ id = 5090, chance = 1000 }, -- treasure map
	{ name = "rum flask", chance = 90 },
	{ name = "light shovel", chance = 500 },
	{ id = 5792, chance = 110 }, -- die
	{ name = "pirate knee breeches", chance = 580 },
	{ name = "pirate bag", chance = 500 },
