...
monster.summon = {
	maxSummons = 2,
	summons = {
		{ name = "Elder Bloodjaw", chance = 100, interval = 2000, count = 3 },
	},
}
...
monster.loot = {
	...
	{ name = "giant amethyst", chance = 110603, maxCount = 3 },
	...
	{ name = "giant topaz", chance = 122080, maxCount = 3 },
	{ id = 46069, chance = 1500}, -- Sanguine Backpack
	{ name = "green gem", chance = 83408, maxCount = 3 },
	{ name = "Norcferatu Bonehood", chance = 4000 },
	{ id = 43504, chance = 2500 }, -- The Essence of Chagorz
	...
	monster.attacks = {
		...
		{ name = "combat", interval = 2000, chance = 40, type = COMBAT_EARTHDAMAGE, minDamage = -1500, maxDamage = -2000, radius = 4, effect = CONST_ME_GREEN_RINGS, target = false },
		{ name = "combat", interval = 2000, chance = 40, type = COMBAT_DEATHDAMAGE, minDamage = -1500, maxDamage = -2000, range = 4, radius = 4, effect = 241, target = true },
		{ name = "combat", interval = 2000, chance = 40, type = COMBAT_EARTHDAMAGE, minDamage = -1500, maxDamage = -2500, length = 10, spread = 0, effect = CONST_ME_POFF, target = false },
		{ name = "combat", interval = 2000, chance = 40, type = COMBAT_LIFEDRAIN, minDamage = -1500, maxDamage = -3000, length = 10, spread = 0, effect = 225, target = false },
		{ name = "speed", interval = 2000, chance = 40, speedChange = -700, radius = 7, effect = CONST_ME_MAGIC_GREEN, target = false, duration = 20000 },
}

monster.defenses = {
	defense = 105,
	armor = 105,
	{ name = "combat", interval = 3000, chance = 10, type = COMBAT_HEALING, minDamage = 2000, maxDamage = 2500, effect = 236, target = false },
