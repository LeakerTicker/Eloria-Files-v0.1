...
monster.loot = {
    { name = "Platinum Coin",        chance = 25390, minCount = 1, maxCount = 48 },
    { name = "Nimmersatt's Seal",    chance =  4335 },
    { id   = 3039,                   chance =  5045 },
    { name = "Molten Dragon Essence",chance =  2360 },
    { name = "Prismatic Quartz",     chance =  2230 },
    { name = "Rainbow Quartz",       chance =  2215, minCount = 1, maxCount = 2 },
    { id   = 3041,                   chance =  3395 },
    { name = "Mega Dragon Heart",    chance =   3025 },
    { name = "Violet Gem",           chance =   735 },
    { name = "Dragon Slayer",        chance =    65 },
}
