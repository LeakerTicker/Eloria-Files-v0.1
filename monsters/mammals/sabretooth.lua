...
monster.attacks = {
	...
	{ name = "sabretooth wave", interval = 5000, chance = 35, minDamage = -280, maxDamage = -560 },
	{ name = "combat", interval = 3500, chance = 30, type = COMBAT_PHYSICALDAMAGE, minDamage = -420, maxDamage = -700, range = 1, effect = CONST_ME_BIG_SCRATCH, target = true },
	{ name = "combat", interval = 2700, chance = 35, type = COMBAT_FIREDAMAGE, minDamage = -490, maxDamage = -700, range = 1, target = true },
}
