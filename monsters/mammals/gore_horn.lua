...
monster.attacks = {
	...
	{ name = "combat", interval = 3500, chance = 20, type = COMBAT_ENERGYDAMAGE, minDamage = -210, maxDamage = -420, length = 7, spread = 0, effect = CONST_ME_ENERGYAREA, target = false },
	{ name = "combat", interval = 4100, chance = 15, type = COMBAT_PHYSICALDAMAGE, minDamage = -280, maxDamage = -490, radius = 7, effect = CONST_ME_EXPLOSIONAREA, target = false },
	{ name = "combat", interval = 2700, chance = 35, type = COMBAT_ENERGYDAMAGE, minDamage = -280, maxDamage = -490, range = 1, shootEffect = CONST_ANI_ENERGY, target = true },
}
