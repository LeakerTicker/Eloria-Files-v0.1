...
monster.attacks = {
	...
	{ name = "combat", interval = 2200, chance = 60, type = COMBAT_PHYSICALDAMAGE, minDamage = -210, maxDamage = -385, range = 7, shootEffect = CONST_ANI_LARGEROCK, target = true },
	{ name = "combat", interval = 3100, chance = 35, type = COMBAT_FIREDAMAGE, minDamage = -315, maxDamage = -455, range = 7, radius = 3, shootEffect = CONST_ANI_FIRE, effect = CONST_ME_FIREATTACK, target = true },
	{ name = "gorerilla large ring", interval = 3500, chance = 35, minDamage = -280, maxDamage = -420 },
	{ name = "gorerilla small ring", interval = 3800, chance = 20, minDamage = -280, maxDamage = -420 },
}
