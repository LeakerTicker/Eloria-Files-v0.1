...
{ name = "combat", interval = 3500, chance = 40, type = COMBAT_FIREDAMAGE, minDamage = -455, maxDamage = -602, range = 7, radius = 4, shootEffect = CONST_ANI_FIRE, effect = CONST_ME_FIREAREA, target = true },
{ name = "blast ring", interval = 4000, chance = 35, minDamage = -420, maxDamage = -560 },
}
