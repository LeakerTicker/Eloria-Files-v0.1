...
monster.loot = {
	...
	{ name = "Onyx Chip", chance = 15000, maxCount = 4 },
	{ name = "Red Crystal Fragment", chance = 15000, maxCount = 3 },
	{ name = "frazzle tongue", chance = 5000 },
	{ name = "frazzle skin", chance = 5000 },
    { id = 19206, chance = 100, minCount = 1, maxCount = 1 }, -- Bounty task item
	{ name = "gummy rotworm", chance = 1000, maxCount = 2 },
	{ name = "assassin dagger", chance = 4000, maxCount = 1 },
	{ name = "dark chocolate coin", chance = 1000, maxCount = 4 },
}
monster.attacks = {
	{ name = "melee", interval = 2000, chance = 100, minDamage = 0, maxDamage = -400 },
	-- bleed
	{ name = "condition", type = CONDITION_BLEEDING, interval = 2000, chance = 10, minDamage = -100, maxDamage = -200, radius = 3, effect = CONST_ME_DRAWBLOOD, target = false },
	{ name = "combat", interval = 2000, chance = 10, type = COMBAT_LIFEDRAIN, minDamage = 0, maxDamage = -400, length = 5, spread = 0, effect = CONST_ME_EXPLOSIONAREA, target = false },
