...
monster.loot = {
	...
	{ name = "Rainbow Quartz", chance = 10000, maxCount = 5 },
    { id = 19206, chance = 100, minCount = 1, maxCount = 1 }, -- Bounty task item
	{ name = "Violet Crystal Shard", chance = 10000, maxCount = 5 },
	{ name = "Violet Gem", chance = 8000, maxCount = 5 },
	{ name = "fairy wings", chance = 5000, maxCount = 4 },
	{ name = "Springsprout Rod", chance = 5000 },
