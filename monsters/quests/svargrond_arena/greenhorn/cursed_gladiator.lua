...
monster.attacks = {
	...
	{ name = "combat", interval = 3100, chance = 37, type = COMBAT_PHYSICALDAMAGE, minDamage = -400, maxDamage = -900, length = 7, spread = 0, effect = CONST_ME_DRAWBLOOD, target = false },
...
monster.defenses = {
	...
	armor = 78,
	--	mitigation = ???,
	{ name = "combat", interval = 2000, chance = 5, type = COMBAT_HEALING, minDamage = 350, maxDamage = 550, effect = CONST_ME_MAGIC_BLUE, target = false },
}
