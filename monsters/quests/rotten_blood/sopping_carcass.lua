...
{ id = 43854, chance = 200 },
    ...
    { name = "Underworld Rod", chance = 3073, maxCount = 1 },
...
monster.attacks = {
	...
	{ name = "combat", interval = 2000, chance = 25, type = COMBAT_DEATHDAMAGE, minDamage = -900, maxDamage = -1250, length = 8, spread = 5, effect = CONST_ME_BLACKSMOKE, target = false },
	{ name = "ice chain", interval = 3000, chance = 15, minDamage = -900, maxDamage = -1100, target = false },
}
