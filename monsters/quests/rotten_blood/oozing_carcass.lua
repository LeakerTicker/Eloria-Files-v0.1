...
monster.attacks = {
	...
	{ name = "combat", interval = 2000, chance = 15, type = COMBAT_DEATHDAMAGE, minDamage = -1100, maxDamage = -1300, radius = 5, effect = CONST_ME_BLACKSMOKE, target = false },
	{ name = "combat", interval = 2000, chance = 20, type = COMBAT_ICEDAMAGE, minDamage = -1100, maxDamage = -1300, radius = 5, effect = CONST_ME_ICEAREA, target = false },
	{ name = "combat", interval = 2000, chance = 25, type = COMBAT_ICEDAMAGE, minDamage = -1100, maxDamage = -1350, length = 8, spread = 5, effect = CONST_ME_ICEAREA, target = false },
	{ name = "largedeathring", interval = 2000, chance = 20, minDamage = -650, maxDamage = -1100, target = false },
	{ name = "energy chain", interval = 3000, chance = 20, minDamage = -850, maxDamage = -1100, target = false },
}
