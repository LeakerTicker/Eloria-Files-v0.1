...
monster.loot = {
	{ name = "deepling axe", chance = 51500 },
	{ name = "depth calcei", chance = 21100 },
	{ id = 13995, chance = 11400 }, -- depth galea
	{ name = "depth lorica", chance = 800 },
	{ name = "ornate chestplate", chance = 5650 },
	{ name = "ornate legs", chance = 6740 },
	{ name = "ornate mace", chance = 61500 },
	{ name = "ornate shield", chance = 11400 },
...
monster.defenses = {
	...
	armor = 40,
	--	mitigation = ???,
	{ name = "combat", interval = 5000, chance = 7, type = COMBAT_HEALING, minDamage = 200, maxDamage = 1000, effect = CONST_ME_MAGIC_BLUE, target = false },
}
