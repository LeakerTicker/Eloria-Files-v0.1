...
monster.loot = {
	{ name = "depth ocrea", chance = 9200 },
	{ name = "ornate mace", chance = 5100 },
	{ name = "ornate shield", chance = 5100 },
...
monster.defenses = {
	...
	armor = 40,
	--	mitigation = ???,
	{ name = "combat", interval = 3000, chance = 40, type = COMBAT_HEALING, minDamage = 80, maxDamage = 110, effect = CONST_ME_MAGIC_BLUE, target = false },
}
