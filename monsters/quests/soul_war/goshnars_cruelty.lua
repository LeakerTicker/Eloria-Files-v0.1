...
monster.loot = {
	...
	{ id = 281, chance = 11500 }, -- giant shimmering pearl (green)
	...
	{ name = "cruelty's chest", chance = 5500 },
	{ name = "cruelty's claw", chance = 5000 },
	{ id = 46044, chance = 1500}, -- Soul War Backpack
	{ name = "figurine of cruelty", chance = 1415 },
	{ name = "spectral saddle", chance = 1410 },
	{ name = "spectral horse tack", chance = 1405 },
...
monster.attacks = {
	...
	{ name = "combat", interval = 2000, chance = 10, type = COMBAT_LIFEDRAIN, minDamage = -1000, maxDamage = -1200, length = 8, spread = 0, effect = CONST_ME_EXPLOSIONAREA, target = false },
	{ name = "singlecloudchain", interval = 6000, chance = 40, minDamage = -1200, maxDamage = -1900, range = 6, effect = CONST_ME_ENERGYHIT, target = true },
	{ name = "combat", interval = 2000, chance = 30, type = COMBAT_PHYSICALDAMAGE, minDamage = -700, maxDamage = -1900, range = 7, radius = 4, shootEffect = CONST_ANI_EXPLOSION, effect = CONST_ME_DRAWBLOOD, target = true },
	{ name = "combat", interval = 2000, chance = 15, type = COMBAT_DEATHDAMAGE, minDamage = -1200, maxDamage = -2000, radius = 3, effect = CONST_ME_GROUNDSHAKER, target = false },
}
