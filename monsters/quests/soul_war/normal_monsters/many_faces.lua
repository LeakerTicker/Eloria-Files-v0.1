...
monster.loot = {
	...
	{ name = "glacier shoes", chance = 4510 },
	...
	{ name = "glacier robe", chance = 3130 },
	{ name = "gruesome fan", chance = 1610 },
	{ name = "glacial rod", chance = 1610 },
...
monster.attacks = {
	...
	{ name = "combat", interval = 4000, chance = 33, type = COMBAT_ICEDAMAGE, minDamage = -504, maxDamage = -595, range = 7, shootEffect = CONST_ANI_SNOWBALL, effect = CONST_ME_ICEATTACK, target = true },
	{ name = "combat", interval = 5000, chance = 44, type = COMBAT_ICEDAMAGE, minDamage = -420, maxDamage = -595, range = 7, radius = 5, shootEffect = CONST_ANI_ICE, effect = CONST_ME_ICEAREA, target = true },
	{ name = "combat", interval = 9500, chance = 59, type = COMBAT_HOLYDAMAGE, minDamage = -385, maxDamage = -560, radius = 4, effect = CONST_ME_HOLYAREA, target = false },
	{ name = "extended holy chain", interval = 10000, chance = 50, minDamage = -455, maxDamage = -560, range = 7 },
