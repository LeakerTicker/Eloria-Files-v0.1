...
monster.loot = {
	{ name = "crystal coin", chance = 164000 },
	...
	{ name = "stone skin amulet", chance = 2570 },
...
monster.attacks = {
	...
	{ name = "combat", interval = 2000, chance = 15, type = COMBAT_FIREDAMAGE, minDamage = -520, maxDamage = -750, range = 7, shootEffect = CONST_ANI_FIRE, effect = CONST_ME_FIREAREA, target = false },
	{ name = "combat", interval = 2000, chance = 10, type = COMBAT_FIREDAMAGE, minDamage = -350, maxDamage = -750, length = 7, effect = CONST_ME_EXPLOSIONHIT, target = false },
	{ name = "combat", interval = 2000, chance = 20, type = COMBAT_DEATHDAMAGE, minDamage = -400, maxDamage = -750, radius = 4, effect = CONST_ME_MORTAREA, target = false },
	{ name = "death chain", interval = 2000, chance = 20, minDamage = -400, maxDamage = -600, target = true },
}
