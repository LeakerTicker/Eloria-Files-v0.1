...
monster.loot = {
	...
	{ name = "the skull of a beast", chance = 1600 },
	{ name = "figurine of spite", chance = 1500 },
...
monster.attacks = {
	...
	{ name = "combat", interval = 2000, chance = 10, type = COMBAT_EARTHDAMAGE, minDamage = -1000, maxDamage = -1500, length = 8, spread = 0, effect = CONST_ME_GREEN_RINGS, target = false },
	{ name = "singlecloudchain", interval = 6000, chance = 40, minDamage = -1000, maxDamage = -1500, range = 6, effect = CONST_ME_ENERGYHIT, target = true },
