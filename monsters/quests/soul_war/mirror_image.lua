...
monster.loot = {
	...
	{ name = "crystal coin", chance = 181310 },
	{ name = "warrior helmet", chance = 6850 },
	{ name = "blue gem", chance = 6230 },
	{ name = "violet gem", chance = 7670 },
	{ name = "glacier mask", chance = 7670 },
	{ name = "glacier amulet", chance = 7670 },
	{ name = "green gem", chance = 7670 },
	{ name = "wood cape", chance = 8120 },
...
monster.attacks = {
	...
	{ name = "combat", interval = 2000, chance = 20, type = COMBAT_ICEDAMAGE, minDamage = -600, maxDamage = -900, range = 7, radius = 4, shootEffect = CONST_ANI_ICE, effect = CONST_ME_BIGCLOUDS, target = true },
	...
	{ name = "combat", interval = 2000, chance = 20, type = COMBAT_HOLYDAMAGE, minDamage = -880, maxDamage = -1050, range = 7, shootEffect = CONST_ANI_HOLY, effect = CONST_ME_HOLYDAMAGE, target = true },
