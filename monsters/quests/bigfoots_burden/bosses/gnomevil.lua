...
monster.loot = {
	...
	{ id = 46385, chance = 1500}, -- Deathstrike Backpack 
...
monster.defenses = {
	...
	armor = 25,
	--	mitigation = ???,
	{ name = "combat", interval = 1000, chance = 25, type = COMBAT_HEALING, minDamage = 100, maxDamage = 400, effect = CONST_ME_MAGIC_BLUE, target = false },
}
