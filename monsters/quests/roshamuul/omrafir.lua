...
monster.health = 2700000
monster.maxHealth = 2700000
monster.race = "fire"
monster.corpse = 6068
monster.speed = 240
monster.manaCost = 0
...
monster.loot = {
	{ id = 16119, chance = 37500, maxCount = 52 }, -- blue crystal shard
	{ id = 20062, chance = 62500, maxCount = 42 }, -- cluster of solace
	{ id = 16125, chance = 43750, maxCount = 32 }, -- cyan crystal fragment
	{ id = 5954, chance = 100000 }, -- demon horn
	{ id = 6499, chance = 812500, maxCount = 400 }, -- demonic essence
	{ id = 20278, chance = 15250 }, -- demonic tapestry
	{ id = 20063, chance = 100000, maxCount = 2 }, -- dream matter
	{ id = 20276, chance = 5250, unique = true }, -- dream warden mask
	...
	{ id = 20277, chance = 16250 }, -- psychedelic tapestry
	{ id = 16126, chance = 6250, maxCount = 3 }, -- red crystal fragment
	{ id = 3098, chance = 62500 }, -- ring of healing
	{ id = 5741, chance = 62500 }, -- skull helmet
	{ id = 3554, chance = 62500 }, -- steel boots
...
monster.attacks = {
	...
	{ name = "omrafir wave", interval = 2000, chance = 40, minDamage = -5000, maxDamage = -10000, target = false },
	{ name = "omrafir beam", interval = 2000, chance = 35, minDamage = -2000, maxDamage = -5000, target = false },
...
monster.defenses = {
	...
	armor = 155,
	--	mitigation = ???,
	{ name = "combat", interval = 2000, chance = 22, type = COMBAT_HEALING, minDamage = 4400, maxDamage = 80000, target = false },
	{ name = "omrafir summon", interval = 2000, chance = 100, target = false },
