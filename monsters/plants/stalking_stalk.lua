...
monster.attacks = {
	...
	{ name = "combat", interval = 4000, chance = 40, type = COMBAT_FIREDAMAGE, minDamage = -600, maxDamage = -850, range = 7, shootEffect = CONST_ANI_FIRE, effect = CONST_ME_HITBYFIRE, target = true },
	{ name = "combat", interval = 2900, chance = 25, type = COMBAT_EARTHDAMAGE, minDamage = -650, maxDamage = -830, radius = 4, effect = CONST_ME_PLANTATTACK, target = false },
}
