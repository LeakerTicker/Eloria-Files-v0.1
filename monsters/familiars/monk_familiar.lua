...
monster.attacks = {
	...
	{ name = "combat", interval = 2000, chance = 80, type = COMBAT_PHYSICALDAMAGE, minDamage = -2400, maxDamage = -3240, range = 1, effect = CONST_ME_HITAREA, target = true },
	{ name = "monk familiar wave", interval = 3000, chance = 60, minDamage = -2040, maxDamage = -2760 },
}
