...
monster.loot = {
	{ name = "wand of inferno", chance = 600 },
	{ id = 35588, chance = 19420 }, -- grappling hook
	{ name = "pirate coin", chance = 1810, maxCount = 10 },
	{ name = "pirat's tail", chance = 1120 },
	{ name = "springsprout rod", chance = 1550 },
	{ name = "wand of starstorm", chance = 550 },
	{ name = "wand of voodoo", chance = 550 },
}
